...
<body>
    ...
    <div style="background-color: #E6F2F8;">
        <form action="user_logged_in.php" method="post">
            ...
            <br>
            <input class="button" style="font-size: 25px;" type="submit" value="Login">
        </form>
        <br>
        <table>
            <tr>
            ...
            <tr>
                <td>
                    <button type="button">
                        <a style="text-decoration: none; font-size: 25px;" href="user_signup.php">User SignUp</a>
                    </button>
                </td>
                <td>
                    <button type="button">
                        <a style="text-decoration: none; font-size: 25px;" href="user_forgot_pwd.php">Forgot Password</a>
                    </button>
                </td>
            </tr>
        </table><br>
    ...
    <!-- Real-time validation to only allow digits and limit to 10 characters -->
    <script>
