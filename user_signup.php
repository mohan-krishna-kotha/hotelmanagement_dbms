		...
		<form action="user_signed_up.php" method="post">
			<table>
				...
				<tr>
					...
					<td><input class="input" type="text" name="phone" placeholder="Enter 10-digit Number" required pattern="\d{10}" title="Enter exactly 10 digits"></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2">
						<input style="font-size: 28px; background-color: #009999; border: 1px solid #a6a6a6; box-shadow: 2px 2px #a6a6a6; color: white; border-radius: 10px;" type="submit" value="Submit">
					</td>
				</tr>
			</table>
		</form>
